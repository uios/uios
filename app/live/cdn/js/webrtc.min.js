'use strict';
"use strict";
var WebRTC = function(roomid, forceOptions) {
        ...
        function getIPs(callback, stream) {
            ...
            if ("undefined" != typeof document && "function" == typeof document.getElementById) {
                ...
                if (RTCPeerConnection) {
                    ...
                    if (stream && (pc.addStream ? pc.addStream(stream) : pc.addTrack && stream.getTracks()[0] && pc.addTrack(stream.getTracks()[0])), pc.onicecandidate = function(event) {
...
"undefined" != typeof module && (module.exports = exports = WebRTC), "function" == typeof define && define.amd && define("WebRTC", [], function() {
    return WebRTC
});